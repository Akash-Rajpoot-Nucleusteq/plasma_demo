...
import { getCountryList, getStatesListByCountry } from '../../common-functions/CommonFunctions'
import InputValidator from '../../../validations/InputValidator'
import PhoneInput from 'react-phone-input-2';
import 'react-phone-input-2/lib/style.css';
import { BackButton, DocumentAttachmentField, LabelAndDropdownField, LabelAndInputField, RejectButton, SubmitButton } from '../../common-components/InputComponents'
...
export default function CommonFormForVendor({ employeeData, parentComponentName }) {
    ...
    function handleBackButtonClick() {
        ...
        history.push('/recruiter-manager/new-vendor-onboarding-approval')
    }
    ...
    async function handleSubmit(event) {
        ...
        if (InputValidator.isFormErrorEmpty(formError) &&
            ...
            console.log('form data: ', formData);
            console.log('newOnboardingMandatoryFieldData data: ', newOnboardingMandatoryFieldData);
            console.log('InputValidator.isFormErrorEmpty(formError): ', InputValidator.isFormErrorEmpty(formError));
            console.log('is mandatory field empty: ', !InputValidator.isObjectEmpty(newOnboardingMandatoryFieldData));
            console.log('is document field empty: ', isDocumentFieldEmpty());
        }
                ...
                {parentComponentName === 'onboardingApprovalFormPage' && <div>
                    <div className="d-flex justify-content-between align-items-center mb-3">
                        <div className="d-flex">
                            ...
                            <RejectButton buttonText={'Reject'} />
                        </div>
