      ...
      <div className='quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card'>
        <div className='card-body'>
          ...
          {userDetails.role === MANAGER && (
            <>
              <NavLink
                to='/manager/assets/my-assets'
                className='list-group-item text-center button-6'
                activeClassName='active'>
                My Asset
              </NavLink>
              <NavLink
                to='/manager/assets/employee-assets'
                className='list-group-item text-center button-6'
                activeClassName='active'>
                Employee Asset
              </NavLink>
          ...
          {userDetails.role === RECRUITER && (
            <>
              <NavLink
                to='/recruiter/assets/my-assets'
                className='list-group-item text-center button-6'
                activeClassName='active'>
                My Asset
              </NavLink>
              <NavLink
                to='/recruiter/assets/employee-assets'
                className='list-group-item text-center button-6'
                activeClassName='active'>
                Employee Asset
              </NavLink>
          ...
          {userDetails.role === RECRUITER_MANAGER && (
            <>
              <NavLink
                to='/recruiter-manager/assets/my-assets'
                className='list-group-item text-center button-6'
                activeClassName='active'>
                My Asset
              </NavLink>
              <NavLink
                to='/recruiter-manager/assets/employee-assets'
                className='list-group-item text-center button-6'
                activeClassName='active'>
                Employee Asset
              </NavLink>
          ...
          {userDetails.role === CLIENT_MANAGER && (
            <>
              <NavLink
                to='/client/assets/my-assets'
                className='list-group-item text-center button-6'
                activeClassName='active'>
                My Asset
              </NavLink>
              <NavLink
                to='/client/assets/employee-assets'
                className='list-group-item text-center button-6'
                activeClassName='active'>
                Employee Asset
              </NavLink>
