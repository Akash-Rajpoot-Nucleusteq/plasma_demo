...
import LeavesToBeApproved from "./leavesToBeApproved";
import { getCurrentDate } from "../../commonFunctions/CommonFunctions";
import { CLIENT_MANAGER, MANAGER, RECRUITER_MANAGER } from "../../assets/common/roles";
...
const Leave = () => {
  ...
  const [showApplyLeaveConfirmationModal, setShowApplyLeaveConfirmationModal] = useState(false);
          ...
          <div className="row">
            ...
            <div className="col-xl-9 col-lg-8  col-md-12">
              <div className="row">
                ...
                {/* Leaves to be approved and approved leave history */}
                {(userDetails.role === MANAGER || userDetails.role === RECRUITER_MANAGER || userDetails.role === CLIENT_MANAGER) && (
                  <>
                    <div className="col-md-12">
                      <LeavesToBeApproved />
                    </div>
