...
import SideBar from "../../account-management/../../components/SideBar";
      ...
      <div className='container-fluid'>
        <div className='row'>
          <div className='col-xl-3 col-lg-4 col-md-12 theiaStickySidebar'>
            {/* <SideBar /> */}
            <SideBar userRole={getCurrentUserDetails().role} headerName={HEADER_ACCOUNT} currentPageName={'Active Client'} />
          </div>
